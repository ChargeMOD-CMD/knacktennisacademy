...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium tennis training in Chennai. Elite coaching, sports science, and performance development for every level." },
      { name: "author", content: "KNACK Tennis Academy" },
